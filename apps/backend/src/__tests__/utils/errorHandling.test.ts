...
describe('Error Handling Utils', () => {
  ...
  describe('safeExecute', () => {
    ...
    it('should throw ApplicationError when operation fails', async () => {
      ...
      // Act & Assert
      await expect(safeExecute(operation, errorMessage, context)).rejects.toThrow(ApplicationError);

      await expect(safeExecute(operation, errorMessage, context)).rejects.toMatchObject({

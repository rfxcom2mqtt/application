...
describe('BridgeDiscovery', () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(discovery, 'publishDiscovery').mockImplementation(() => {});
  });
  ...
  describe('start', () => {
    it('should call parent start method', async () => {
      // Arrange
      const superStartSpy = vi.spyOn(Object.getPrototypeOf(BridgeDiscovery.prototype), 'start');
  ...
  describe('stop', () => {
    it('should call parent stop method', async () => {
      // Arrange
      const superStopSpy = vi.spyOn(Object.getPrototypeOf(BridgeDiscovery.prototype), 'stop');

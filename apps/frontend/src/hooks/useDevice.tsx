...
export function useDevice() {
    ...
    const handleSwitchAction = React.useCallback((entity: DeviceSwitch, action: string) => {
        if (!id || !state) return;
    ...
    const handleSensorRename = React.useCallback((entity: DeviceSensor, name: string) => {
        if (id) {
    ...
    const handleSwitchRename = React.useCallback((entity: DeviceSwitch, name: string) => {
        if (id) {
    ...
    const handleDeviceRename = React.useCallback((deviceName: string) => {
        if (id) {
    ...
    const getEntityCounts = React.useCallback(() => {
        ...
        counts.total = counts.sensors + counts.switches + counts.binarySensors + counts.covers + counts.selects;

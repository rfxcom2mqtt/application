...
import { Box, Typography, Divider, Paper, Grid, Collapse, Alert, Chip } from '@mui/material';
import {
  Home as HomeIcon,
    ...
    <Box>
      ...
      >
        ...
        {!settings.discovery && (
          <Alert severity="info" sx={{ mt: 2 }}>
            ...
            discovered by Home Assistant. You can still manually configure them using the MQTT
            integration.
          </Alert>
        )}
        ...
        {settings.discovery && (
          <Alert severity="success" sx={{ mt: 2 }}>
            <Typography variant="body2">
              <strong>Discovery enabled!</strong> Your RFXcom devices will automatically appear in
              Home Assistant under the MQTT integration. Make sure your Home Assistant MQTT
              integration is configured to use the same broker as RFXcom2MQTT.
            </Typography>
          </Alert>
        )}
      </SettingGroup>
      ...
      <Collapse in={settings.discovery}>
        ...
        >
          ...
          <Alert severity="info" sx={{ mt: 2 }}>
            <Typography variant="body2">
              <strong>Discovery Topic Structure:</strong>
              <br />
              Devices will be published to:{' '}
              <code>
                {settings.discovery_topic || 'homeassistant'}/[component]/[device_id]/config
              </code>
            </Typography>
          </Alert>
        </SettingGroup>
        ...
        >
          ...
          <Alert severity="warning">
            <Typography variant="body2">
              <strong>Note:</strong> Changes to discovery settings require restarting RFXcom2MQTT to
              take effect. Existing devices in Home Assistant may need to be manually removed and
              re-discovered if you change the discovery topic or device prefix.
            </Typography>
          </Alert>
        </SettingGroup>
      </Collapse>

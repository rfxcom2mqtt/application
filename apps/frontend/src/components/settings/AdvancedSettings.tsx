      ...
      >
        ...
        <Alert severity="info" sx={{ mb: 2 }}>
          ...
          <Box component="ul" sx={{ pl: 2, m: 0 }}>
            <li>
              <strong>DEBUG:</strong> Use for development and detailed troubleshooting
            </li>
            <li>
              <strong>INFO:</strong> Recommended for normal operation
            </li>
            <li>
              <strong>WARN:</strong> Use to reduce log verbosity while catching issues
            </li>
            <li>
              <strong>ERROR:</strong> Only log serious errors and failures
            </li>
          </Box>
        </Alert>
        ...
        {logLevel === 'debug' && (
          <Alert severity="warning">
            <Typography variant="body2">
              <strong>Debug mode enabled:</strong> This will generate verbose logs that may impact
              performance. Consider using INFO level for production environments.
            </Typography>
          </Alert>
        )}
        ...
        {logLevel === 'error' && (
          <Alert severity="warning">
            <Typography variant="body2">
              <strong>Error-only logging:</strong> Only critical errors will be logged. This may
              make troubleshooting difficult if issues arise.
            </Typography>
          </Alert>
        )}
      </SettingGroup>

    ...
    <>
      ...
      <Card sx={{ mb: 3, borderRadius: 3 }}>
        <CardContent>
          ...
          <List dense>
            <ListItem>
              <ListItemText primary={t('deviceInfo.name')} secondary={device.name} />
            </ListItem>
            ...
            <ListItem>
              <ListItemText primary={t('deviceInfo.rfxcomId')} secondary={device.id} />
            </ListItem>
            ...
            <ListItem>
              <ListItemText primary={t('deviceInfo.type')} secondary={device.type} />
            </ListItem>

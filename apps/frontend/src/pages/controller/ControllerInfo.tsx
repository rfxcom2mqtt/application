  ...
  return (
    ...
    >
      ...
      <Card sx={{ mb: 3 }}>
        ...
        <CardContent>
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} sm={8}>
              <Typography>
                {controllerInfo?.coordinator.firmwareType || t('common.unknown')}
              </Typography>
            </Grid>
            ...
            <Grid item xs={6} sm={8}>
              <Typography>
                {controllerInfo?.coordinator.firmwareVersion || t('common.unknown')}
              </Typography>
            </Grid>
            ...
            <Grid item xs={6} sm={8}>
              <Typography>
                {controllerInfo?.coordinator.hardwareVersion || t('common.unknown')}
              </Typography>
            </Grid>
            ...
            <Grid item xs={6} sm={8}>
              <Typography>
                {controllerInfo?.coordinator.receiverType || t('common.unknown')}
              </Typography>
            </Grid>
            ...
            <Grid item xs={6} sm={8}>
              <Typography>
                {controllerInfo?.coordinator.receiverTypeCode || t('common.unknown')}
              </Typography>
            </Grid>
          </Grid>
        </CardContent>
      ...
      <Dialog open={restartDialogOpen} onClose={() => setRestartDialogOpen(false)}>
        ...
        <DialogContent>
          <DialogContentText>{t('controller.restart.confirmMessage')}</DialogContentText>
        </DialogContent>
        <DialogActions>
